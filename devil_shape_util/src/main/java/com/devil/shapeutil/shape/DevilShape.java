package com.devil.shapeutil.shape;
...
public class DevilShape implements IDevilShape<Drawable, View> {
    //样式-矩形
    ...
    public DevilShape(Context context, int shapeModel) {
        mContext = context;
        shape = shapeModel;
    }
     ...
     * @return BaseShape
     */
    public DevilShape solid(@ColorRes int backgroundColorResId) {
        this.isBackgroundColor = true;
        this.backgroundColor = mContext.getResources().getColor(backgroundColorResId);
        return this;
    }
     ...
     * @return BaseShape
     */
    public DevilShape solid(String backgroundColor) {
        this.isBackgroundColor = true;
     ...
     * @return BaseShape
     */
    public DevilShape line(int lineWidth, @ColorRes int lineColorResId) {
        this.isLine = true;
        this.lineWidth = lineWidth;
        this.lineColor = mContext.getResources().getColor(lineColorResId);
        return this;
    }
     ...
     * @return BaseShape
     */
    public DevilShape line(int lineWidth, String lineColor) {
        this.isLine = true;
        this.lineWidth = lineWidth;
     ...
     * @return BaseShape
     */
    public DevilShape dashLine(int dashLineWidth, @ColorRes int dashLineColorResId, float dashWidth, float dashGap) {
        this.isDashLine = true;
        this.dashLineWidth = dashLineWidth;
        this.dashWidth = dashWidth;
        this.dashGap = dashGap;
        this.dashLineColor = mContext.getResources().getColor(dashLineColorResId);
        return this;
    }
     ...
     * @return BaseShape
     */
    public DevilShape dashLine(int dashLineWidth, String dashLineColor, float dashWidth, float dashGap) {
        this.isDashLine = true;
        this.dashLineWidth = dashLineWidth;
        this.dashWidth = dashWidth;
        this.dashGap = dashGap;
     ...
     * @return BaseShape
     */
    public DevilShape gradient(@ColorRes int startColor, @ColorRes int endColor) {
        this.isGradient = true;
        this.gradientColors = new int[2];
        this.gradientColors[0] = mContext.getResources().getColor(startColor);
        this.gradientColors[1] = mContext.getResources().getColor(endColor);
     ...
     * @return BaseShape
     */
    public DevilShape gradient(String startColor, String endColor) {
        this.isGradient = true;
        this.gradientColors = new int[2];
     ...
     * @return BaseShape
     */
    public DevilShape gradientLinear(@ColorRes int... gradientColorsResId) {
        this.isGradient = true;
        this.gradientType = GradientDrawable.LINEAR_GRADIENT;
        this.gradientOrientation = TOP_BOTTOM;
        if (gradientColorsResId.length > 1) {
            ...
            for (int i = 0; i < gradientColorsResId.length; i++) {
                this.gradientColors[i] = mContext.getResources().getColor(gradientColorsResId[i]);
            }
        } else {
     ...
     * @return BaseShape
     */
    public DevilShape gradientLinear(String... gradientColorsResId) {
        this.isGradient = true;
        this.gradientType = GradientDrawable.LINEAR_GRADIENT;
        this.gradientOrientation = TOP_BOTTOM;
        if (gradientColorsResId.length > 1) {
     ...
     * @return BaseShape
     */
    public DevilShape gradientLinear(@GradientOrientation String gradientOrientation, @ColorRes int... gradientColorsResId) {
        this.isGradient = true;
        this.gradientType = GradientDrawable.LINEAR_GRADIENT;
     ...
     * @return BaseShape
     */
    public DevilShape gradientLinear(@GradientOrientation String gradientOrientation, String... gradientColors) {
        this.isGradient = true;
        this.gradientType = GradientDrawable.LINEAR_GRADIENT;
        this.gradientOrientation = gradientOrientation;
     ...
     * @return BaseShape
     */
    public DevilShape gradientSweep(int... gradientColors) {
        this.isGradient = true;
        this.gradientType = GradientDrawable.SWEEP_GRADIENT;
        if (gradientColors.length > 1) {
            this.gradientColors = new int[gradientColors.length];
            for (int i = 0; i < gradientColors.length; i++) {
                this.gradientColors[i] = mContext.getResources().getColor(gradientColors[i]);
            }
        } else {
            throw new ExceptionInInitializerError("渐变颜色数组至少需要两个颜色");
        }
     ...
     * @return BaseShape
     */
    public DevilShape gradientSweep(String... gradientColors) {
        this.isGradient = true;
        this.gradientType = GradientDrawable.SWEEP_GRADIENT;
        if (gradientColors.length > 1) {
            this.gradientColors = new int[gradientColors.length];
     ...
     * @return BaseShape
     */
    public DevilShape gradientRadial(float radialRadius, int... gradientColors) {
        this.isGradient = true;
     ...
     * @return BaseShape
     */
    public DevilShape gradientRadial(float radialRadius, String... gradientColors) {
        this.isGradient = true;
        this.gradientType = GradientDrawable.RADIAL_GRADIENT;
        this.radialRadius = radialRadius;
        if (gradientColors.length > 1) {
     ...
     * @param radius 圆角弧度
     */
    public DevilShape radius(float radius) {
        this.isRadius = true;
     ...
     * @return DevShape
     */
    public DevilShape trRadius(float topRightRadius) {
        this.isRadius = true;
     ...
     * @return DevShape
     */
    public DevilShape tlRadius(float topLeftRadius) {
        this.isRadius = true;
     ...
     * @return DevShape
     */
    public DevilShape brRadius(float bottomRightRadius) {
        this.isRadius = true;
     ...
     * @return DevShape
     */
    public DevilShape blRadius(float bottomLeftRadius) {
        this.isRadius = true;
